<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('departments.store') }}" method="post" class="max-w-md mx-auto mt-8 bg-white dark:bg-gray-800 p-6 rounded-md shadow-md">
                @csrf

                <h3 class='text-lg font-semibold mb-4 text-gray-800 dark:text-white'>Add Department</h3>
                ...
                <div class="flex justify-end">
                    <x-primary-button>
                        {{ svg('css-add', 'w-5 h-5') }} {{ __('Create Department') }}
                    </x-primary-button>
                </div>
            </form>
        </div>
